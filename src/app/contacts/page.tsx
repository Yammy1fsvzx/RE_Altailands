                  ...
                  <div>
                    ...
                    <div className="flex gap-4">
                      {contactInfo?.socialMedia?.whatsapp && (
                        <a 
                          href={`https://wa.me/7${contactInfo.socialMedia.whatsapp}`}
                          target="_blank"
                      ...
                      {contactInfo?.socialMedia?.telegram && (
                        <a 
                          href={`https://t.me/${contactInfo.socialMedia.telegram}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="w-12 h-12 bg-green-50 rounded-xl flex items-center justify-center hover:bg-green-100 transition-colors"
                        >
                      ...
                      {contactInfo?.socialMedia?.instagram && (
                        ...
                        >
                          <svg className="w-6 h-6 text-green-600" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zm5.52 17.28c.12.24.12.36 0 .48a.546.546 0 0 1-.48.12h-11.04c-.24 0-.36-.12-.48a.546.546 0 0 1 0-.48c.12-.12 2.64-2.16 3.84-3.36 1.2-1.2 2.4-1.44 3.6.24 4.8 1.2 1.2 3.36 1.44 4.56.24zM12 10.8c-2.64 0-4.8 2.16-4.8 4.8s2.16 4.8 4.8 4.8 4.8-2.16 4.8-4.8-2.16-4.8-4.8-4.8z"/>
                          </svg>
                        </a>
                      )}
                    </div>
