...
export default function Header() {
  ...
  const { contactInfo, isLoading } = useContacts()
  ...
  const getHeaderStyles = () => {
    ...
    return isScrolled ? 'bg-white shadow-md py-2' : 'bg-white py-3 md:py-4'
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        <Link href="/" className="relative z-10">
          <div className="flex items-center">
            <div className="relative w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 mr-2">
              <div className="absolute inset-0 bg-white rounded-full shadow-md p-0.5 sm:p-1">
          ...
          <div className="hidden md:flex items-center space-x-3 lg:space-x-4">
            {contactInfo.phone && (
              <button 
                ...
                className="btn-primary bg-[#16a34a] hover:bg-[#15803d] py-1 sm:py-1.5 px-2 sm:px-3 flex items-center text-xs sm:text-sm font-medium transition-all"
